...
"""
import numpy as np
from tomopy import recon, normalize, minus_log, circ_mask, remove_nan
...
def recon_wrapper(projs, beam, theta, pad_frac = 0.8, mask_ratio = 0.95, contrast_s = 0.001):
    ...
    # beam = np.roll(beam, -5, axis=1)  mean flat filed or random sample flat field
    # flat field center, shift flat filed center
